...
That claim is asserted offline in test_venues.py against a hardcoded table of
expected OpenFIGI identities. This script checks the other half: that OpenFIGI
actually returns those identities. A mismatch means either the code mapping is
wrong or the stored symbol is, and both are worth knowing.
